...
--
 1. National/regional **communities** (me: RSE Leaders, N8 CIR, UK RSE conf (2018 talks chair); team: RSE Soc committee, SSI Fellows)
...
* **Packaging up reusable components** should help;
    ...
    * Easier to implement testing, autogenerated docs, sensible versioning
